        ...
        return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    <EducationPortrait  image={alMoreInfo} name={"MÁLMAR"} text={"​<p><strong>SORPA</strong> hefur sett upp véltæka flokkun sem nær málmum úr blönduðum úrgangi með segulfæriböndum og því þarf ekki að flokka málma sér. Höldum málmum til haga og setjum þá síðan beint í tunna, í lausu.</p><br /><p><strong>Málma</strong> má endurvinna aftur og aftur. Öllum tegundum málma má skila á endurvinnslustöðvar eða í lausu í gráu heimilistunnuna.</p><br /><p><strong>Endurvinnsla</strong> á málmi t.d. Niðursuðudósum, sem barst til <strong>SORPU</strong> árið 2016 sparaði orku sem jafngildir rafmagnsnotkun 23.000 heimila á ári.</p>"} />     
                </div>
            </div>
            <div className="container">
                <div className="row">
                    <EducationPortrait  image={raudiKrossinnMoreInfo} name={"RAUÐI KROSSINN"} text={"<p><strong>Rauði Krossinn</strong> endurnýtir illa farinn fatnað. Öll föt, klæði, teppi, rúmföt og annað úr efni má fara í gáminn þeirra. Þegar gámurinn er orðinn fullur er hann sendur í flokkunarstöð Rauða Krossins þar sem heil föt eru flokkuð frá þeim ónýtu. Ónýtu fötin, klæðin og efni eru tætt niður og búið til úr þeim nýjir og endurunnir efnisstrangar til að sauma úr.</p><br /><p>Gott er að hafa <strong>skópörin í pokum eða binda reimarnar saman</strong> svo ekki þurfi að byrja á að para skóna saman. Það sparar vinnu og fyrirhöfn við flokkun og kemur í veg fyrir sóun.</p>"} />
